...
import '../../../../user/modules/chat/chat_list_item.dart';
...
class ShelterChatView extends StatelessWidget {
  const ShelterChatView({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(ShelterChatController());
